...
#else
    private OutlineRenderPass _opaquePass;
    private OutlineRenderPass _transparentPass;
#endif

    public override void Create()
    {
#if UNITY_6000_0_OR_NEWER
        var profilerTagName = nameof(OutlineRenderFeature);
        var shaderTags = new[] { "Outline" };
        var layerMask = -1;

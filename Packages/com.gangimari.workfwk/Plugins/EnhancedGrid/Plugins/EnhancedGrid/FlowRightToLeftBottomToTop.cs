namespace echo17.EnhancedUI.EnhancedGrid
{
    ...
    public struct FlowRightToLeftBottomToTop : IFlow
    {
        private EnhancedGrid _grid;

        public FlowRightToLeftBottomToTop(EnhancedGrid grid)
        {
            _grid = grid;
        }
        ...
        {
            return EnhancedGrid.EnhancedGridFlowDirection.RightToLeftBottomToTop;
        }
        ...
        {
            return groupCount - referenceIndex - 1;
        }
        ...
        {
            return new Vector2(groupRect.xMax - firstGroupCellActualSize.x, groupRect.position.y);
        }
        ...
        {
            return new Vector2(-nextCellActualSize.x - _grid.CellLayoutSpacing, 0f);
        }
    }
}

namespace echo17.EnhancedUI.EnhancedGrid
{
    ...
    public struct FlowRightToLeftTopToBottom : IFlow
    {
        private EnhancedGrid _grid;

        public FlowRightToLeftTopToBottom(EnhancedGrid grid)
        {
            _grid = grid;
        }
        ...
        {
            return EnhancedGrid.EnhancedGridFlowDirection.RightToLeftTopToBottom;
        }

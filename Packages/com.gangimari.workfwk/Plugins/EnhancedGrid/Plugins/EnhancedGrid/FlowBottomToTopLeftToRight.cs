namespace echo17.EnhancedUI.EnhancedGrid
{
    ...
    public struct FlowBottomToTopLeftToRight : IFlow
    {
        private EnhancedGrid _grid;

        public FlowBottomToTopLeftToRight(EnhancedGrid grid)
        {
            _grid = grid;
        }
        ...
        {
            return EnhancedGrid.EnhancedGridFlowDirection.BottomToTopLeftToRight;
        }

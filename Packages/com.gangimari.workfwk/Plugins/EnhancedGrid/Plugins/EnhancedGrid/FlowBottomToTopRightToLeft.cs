namespace echo17.EnhancedUI.EnhancedGrid
{
    ...
    public struct FlowBottomToTopRightToLeft : IFlow
    {
        private EnhancedGrid _grid;

        public FlowBottomToTopRightToLeft(EnhancedGrid grid)
        {
            _grid = grid;
        }
        ...
        {
            return EnhancedGrid.EnhancedGridFlowDirection.BottomToTopRightToLeft;
        }
        ...
        {
            return groupEndCellDataIndex - (referenceIndex - groupStartCellDataIndex);
        }

        public int GetNextCellDataIndex(int referenceIndex, int groupStartCellDataIndex, int groupEndCellDataIndex)
        {
            return (referenceIndex > groupStartCellDataIndex ? referenceIndex - 1 : -1);
        }

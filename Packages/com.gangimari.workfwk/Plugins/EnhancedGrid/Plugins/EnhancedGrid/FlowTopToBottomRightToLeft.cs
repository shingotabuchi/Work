namespace echo17.EnhancedUI.EnhancedGrid
{
    ...
    public struct FlowTopToBottomRightToLeft : IFlow
    {
        private EnhancedGrid _grid;

        public FlowTopToBottomRightToLeft(EnhancedGrid grid)
        {
            _grid = grid;
        }
        ...
        {
            return EnhancedGrid.EnhancedGridFlowDirection.TopToBottomRightToLeft;
        }

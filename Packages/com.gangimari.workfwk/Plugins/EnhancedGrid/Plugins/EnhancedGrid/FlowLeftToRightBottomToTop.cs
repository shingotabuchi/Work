namespace echo17.EnhancedUI.EnhancedGrid
{
    ...
    public struct FlowLeftToRightBottomToTop : IFlow
    {
        private EnhancedGrid _grid;

        public FlowLeftToRightBottomToTop(EnhancedGrid grid)
        {
            _grid = grid;
        }
        ...
        {
            return EnhancedGrid.EnhancedGridFlowDirection.LeftToRightBottomToTop;
        }
